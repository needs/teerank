...
function Tab({ label, isActive }: { label: string; isActive: boolean }) {
  return (
    <div
      className={twMerge(
        'px-4 py-1.5 rounded-t-md border border-[#dddddd] border-b-0 text-base',
      ...
      <body className="bg-[url('/background.png')] bg-repeat-x bg-left-top flex flex-col items-center m-0 bg-[#9EB5D6] text-[#666]">
        ...
        <main className="max-w-5xl w-full rounded-xl bg-[#e7e5be] shadow-sm">
          <header className="flex flex-row gap-2 -mt-1.5 px-8">
            <Tab label="Home" isActive={true} />
            <Tab label="CTF" isActive={false} />
            <div className="grow" />
            <Tab label="About" isActive={false} />
          </header>

          <main className="bg-white rounded-xl shadow-md h-[800px]">
            {children}
          </main>
        </main>
